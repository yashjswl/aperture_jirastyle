    ...
    <header className="flex h-16 items-center justify-between border-b border-white/10 bg-[rgba(255,255,255,0.02)] backdrop-blur-xl px-8 shrink-0 z-10 sticky top-0 shadow-[0_4px_24px_rgba(0,0,0,0.5)]">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="relative group flex items-center">
          ...
          <div className="absolute right-0 top-full mt-2 w-56 rounded-2xl bg-[rgba(255,255,255,0.05)] backdrop-blur-2xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.8)] opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform origin-top-right scale-95 group-hover:scale-100 overflow-hidden z-50">
